<?php if(!($useWholesaleLayout ?? false)): ?>
<?php $__env->startSection('title', $seoData['title'] ?? $product->name); ?>
<?php else: ?>
<?php $__env->startSection('page-title', $product->name); ?>
<?php endif; ?>

<?php $__env->startPush('head'); ?>
    <?php if(isset($seoData['description'])): ?>
    <meta name="description" content="<?php echo e($seoData['description']); ?>">
    <?php endif; ?>
    
    <?php if(isset($seoData['og_title'])): ?>
    <meta property="og:title" content="<?php echo e($seoData['og_title']); ?>">
    <meta property="og:description" content="<?php echo e($seoData['og_description']); ?>">
    <meta property="og:image" content="<?php echo e($seoData['og_image']); ?>">
    <meta property="og:url" content="<?php echo e($seoData['og_url']); ?>">
    <meta property="og:type" content="product">
    <?php endif; ?>
    
    <?php if(isset($seoData['schema'])): ?>
    <script type="application/ld+json">
    <?php echo json_encode($seoData['schema'], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>
    ...
    <div class="container">
        ...
        <div class="product-layout">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <?php if(count($images) > 0): ?>
                                        ...
                                        <div class="swiper-slide" role="button" tabindex="0" aria-label="Изображение <?php echo e($index + 1); ?> из <?php echo e(count($images)); ?>">
                                            <div class="product-gallery__image">
                                                <img src="<?php echo e($image->url); ?>" alt="<?php echo e($product->name); ?> - изображение <?php echo e($index + 1); ?>" onerror="this.onerror=null; this.src='/assets/img/product_empty.jpg';">
                                            </div>
                                        </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                                        <div class="swiper-slide" role="button" tabindex="0" aria-label="Изображение товара">
                                            <div class="product-gallery__image">
                                                <img src="/assets/img/product_empty.jpg" alt="<?php echo e($product->name); ?>">
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            ...
                            <div class="swiper-wrapper">
                                <?php if(count($images) > 0): ?>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product-gallery__image">
                                            <img src="<?php echo e($image->url); ?>" alt="<?php echo e($product->name); ?> - изображение <?php echo e($index + 1); ?>" onerror="this.onerror=null; this.src='/assets/img/product_empty.jpg';" role="button" tabindex="0" aria-label="Нажмите для увеличения">
                                        </div>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    <div class="swiper-slide">
                                        <div class="product-gallery__image">
                                            <img src="/assets/img/product_empty.jpg" alt="<?php echo e($product->name); ?>" role="button" tabindex="0" aria-label="Нажмите для увеличения">
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
            ...
            <div class="product-info-column">
                ...
                <?php if($reviewsStats['total_count'] > 0): ?>
                <div data-widget="webPdpGrid"
                    ...
                    <div data-widget="webSingleProductScore"><a
                            ...
                            <div class="ga5_3_10-a2 tsBodyControl500Medium"><?php echo e($reviewsStats['average_rating']); ?> • <?php echo e($reviewsStats['total_count']); ?> отзыв<?php echo e($reviewsStats['total_count'] > 1 ? 'ов' : ''); ?></div>
                        </a>
                    </div>
                ...
                <div data-widget="webPdpGrid"
                            ...
                            <div class="pdp_r3 pdp_a8g">
                                ...
                                <div class="pdp_q6">
                                    <div screen-offset="16" class="ea5_3_12-a pdp_q8">
                                        ...
                                        ?>
                                        <?php if($product_type_attr && isset($product_type_attr->value)): ?>
                                        <?php if(isset($product_type_attr->product_type_id) && $product_type_attr->product_type_id > 0): ?>
                                        <a href="/product_type/?product_type_id=<?php echo e($product_type_attr->product_type_id); ?>"
                                                class="pdp_f3 pdp_f4">
                                            <div class="pdp_f6">
                                                <div title="" class="pdp_e7 pdp_e8 pdp_f2 pdp_r" style="cursor: pointer;">
                                                    <div class="pdp_q3">
                                                        <span class="q6b3_0_4-a pdp_q5 pdp_f1">
                                                            <span style="color:;"><?php echo e($product_type_attr->value); ?></span>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div data-widget="webShortCharacteristics" class="pdp_mb5">
                        ...
                        <div class="pdp_bm6">
                            ...
                            <?php if($attr->name == "Авторы" && $attr->value && $attr->value != ''): ?>
                            <div class="pdp_b6m pdp_b2m">
                                ...
                                <div class="pdp_mb2 pdp_m3b"><span class="pdp_b4m tsBody400Small"
                                                                   style="color:var(--textPrimary);"><?php echo e($attr->value); ?></span>
                                </div>
                            </div>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($attr->name == "Издательство" && $attr->value && $attr->value != ''): ?>
                            <div class="pdp_b6m pdp_b2m">
                                <div class="pdp_mb2 pdp_bm3"><span class="q6b3_0_4-a pdp_b3m"><span
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($attr->name == "Серия" && $attr->value && $attr->value != ''): ?>
                            <div class="pdp_b6m pdp_b2m">
                                <div class="pdp_mb2 pdp_bm3"><span class="q6b3_0_4-a pdp_b3m"><span
                                                class="tsBodyM" style="color:var(--textSecondary);">Серия</span></span>
                                </div>
                                <div class="pdp_mb2 pdp_m3b">
                                    <?php if(isset($attr->seriya_id) && $attr->seriya_id > 0): ?>
                                    <a href="/seriya/?seriya_id=<?php echo e($attr->seriya_id); ?>" class="pdp_b4m tsBody400Small" style="color:var(--textAction); text-decoration: none;"><?php echo e($attr->value); ?></a>
                                    <?php else: ?>
                                    <span class="pdp_b4m tsBody400Small" style="color:var(--textPrimary);"><?php echo e($attr->value); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($attr->name == "Год" && $attr->value && $attr->value != ''): ?>
                            <div class="pdp_b6m pdp_b2m">
                                <div class="pdp_mb2 pdp_bm3"><span class="q6b3_0_4-a pdp_b3m"><span
            ...
            <div class="product-purchase-sidebar">
                <div class="purchase-sticky-content">
                    ...
                    <div class="quantity-selector" style="display: none;">
                        ...
                        <input type="number" class="quantity-input" id="quantityInput" value="1" min="1" max="<?php if(isset($product->quantity) && $product->quantity > 0): ?><?php echo e($product->quantity); ?><?php endif; ?>">
                    ...
                    <div data-widget="webPdpGrid"
                                ...
                                <div screen-offset="8" class="ea5_3_12-a pdp_ga">
                                    <div class="pdp_fa7">
                                        <div screen-offset="16" fixed="" class="ea5_3_12-a pdp_f7a">
                                            <button  data-product-id="<?php echo e($product->id); ?>"  class="btn-add-to-cart pdp_f5a pdp_ag b25_5_1-a0 b25_5_1-b3 b25_5_1-a5"
                                        ...
                                        <div class="pdp_a6f">
                                            <div class="pdp_a7f">
                                                <a href="#" class="btn-buy-all" data-product-id="<?php echo e($product->id); ?>" data-max-quantity="<?php if(isset($product->quantity) && $product->quantity > 0): ?><?php echo e($product->quantity); ?><?php endif; ?>">Купить всё</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div data-widget="webAddToFavorite" class="ea5_3_12-a">
                            <button data-product-id="<?php echo e($product->id); ?>" aria-label="Добавить в избранное" class="product-favorite pdp_a1g ag5_6_1-a0 ag5_6_1-a4"
                                ...
                                <?php if(isset($favorites['items'][$product->id])): ?>
                    ...
                    <div class="pdp_i1a">
                        <div style="width: calc(50%);">
                            ...
                            <dl class="pdp_i5a">
                                ...
                                <dd class="pdp_ai5"><span class="pdp_ia6"><span class="pdp_i6a"><?php echo e($product->id); ?></span><div
                            ...
                            <?php endif; ?>
                            <?php if(count($attributes) > 0): ?>
                            <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($index % 2 == 0): ?>
                            <?php if($attr->value && $attr->value != ''): ?>
                            <dl class="pdp_i5a">
                                <dt class="pdp_i4a"><span class="pdp_a5i"><?php echo e($attr->name); ?></span></dt>
                                <dd class="pdp_ai5">
                                    <?php if($attr->name == "Серия" && isset($attr->seriya_id) && $attr->seriya_id > 0): ?>
                                    <a target="_blank" href="/seriya/?seriya_id=<?php echo e($attr->seriya_id); ?>" style="color: var(--textAction); text-decoration: none;"><?php echo e($attr->value); ?></a>
                                    <?php elseif($attr->name == "Тематика" && isset($attr->topic_id) && $attr->topic_id > 0): ?>
                                    <a target="_blank" href="/topic/?topic_id=<?php echo e($attr->topic_id); ?>" style="color: var(--textAction); text-decoration: none;"><?php echo e($attr->value); ?></a>
                                    <?php elseif($attr->name == "Тип товара" && isset($attr->product_type_id) && $attr->product_type_id > 0): ?>
                                    <a target="_blank" href="/product_type/?product_type_id=<?php echo e($attr->product_type_id); ?>" style="color: var(--textAction); text-decoration: none;"><?php echo e($attr->value); ?></a>
                                    <?php else: ?>
                        ...
                        <div class="" data-widget="webListReviews"> 
                            ...
                            <div class="pm1_28">
                                <div class="p2m_28">
                                    ...
                                    <div data-review-uuid="<?php echo e($review->review_id); ?>"
                                         class="ql7_28">
                                        <div class="q7l_28">
                                            <div class="n1l_28 ln2_28">
                                                <div class="yk0_28 k1y_28 l2n_28"><span><?php echo e($review->first_letter); ?></span></div>
                                                <div>
                                            ...
                                            <div class="lq0_28">
                                                <?php if($review->formatted_date): ?>
                                                <div class="l0q_28"> <?php echo e($review->formatted_date); ?></div>
                                                <?php endif; ?>
                                                <div class="q0l_28">
                                                    <div class="a5d5_3_10-a a5d5_3_10-a0">
                                                        <?php $review_rating = $review->rating; ?>
                                                        <?php for($star_num = 1; $star_num <= 5; $star_num++): ?>
                                                        <?php if($review_rating >= $star_num): ?>
                    ...
                    <div class="m4z_28">
                        <div class="zm4_28">
                            <div class="a5d5_3_10-a a5d5_3_10-a2">
                                <?php $avg_rating = $reviewsStats['average_rating']; ?>
                                <?php for($star_num = 1; $star_num <= 5; $star_num++): ?>
                                <?php if($avg_rating >= $star_num): ?>
                            ...
                            <div class="z5m_28"><span><?php echo e($reviewsStats['average_rating']); ?> / 5</span></div>
                        </div>
                        ...
                        <div class="z4m_28">
                            <div class="m6z_28">
                                ...
                                <div class="zm6_28">
                                    <div class="z6m_28">
                                        <div class="mz7_28" style="width: <?php echo e($reviewsStats['rating_distribution'][5]['percent']); ?>%;"></div>
                                    </div>
                                </div>
                                <div class="zm7_28"><?php echo e($reviewsStats['rating_distribution'][5]['count']); ?></div>
                            </div>
                            <div class="m6z_28">
                                <div class="m7z_28">4 звезды</div>
                                <div class="zm6_28">
                                    <div class="z6m_28">
                                        <div class="mz7_28" style="width: <?php echo e($reviewsStats['rating_distribution'][4]['percent']); ?>%;"></div>
                                    </div>
                                </div>
                                <div class="zm7_28"><?php echo e($reviewsStats['rating_distribution'][4]['count']); ?></div>
                            </div>
                            <div class="m6z_28">
                                <div class="m7z_28">3 звезды</div>
                                <div class="zm6_28">
                                    <div class="z6m_28">
                                        <div class="mz7_28" style="width: <?php echo e($reviewsStats['rating_distribution'][3]['percent']); ?>%;"></div>
                                    </div>
                                </div>
                                <div class="zm7_28"><?php echo e($reviewsStats['rating_distribution'][3]['count']); ?></div>
                            </div>
                            <div class="m6z_28">
                                <div class="m7z_28">2 звезды</div>
                                <div class="zm6_28">
                                    <div class="z6m_28">
                                        <div class="mz7_28" style="width: <?php echo e($reviewsStats['rating_distribution'][2]['percent']); ?>%;"></div>
                                    </div>
                                </div>
                                <div class="zm7_28"><?php echo e($reviewsStats['rating_distribution'][2]['count']); ?></div>
                            ...
                            <div class="m6z_28">
                                ...
                                <div class="zm6_28">
                                    <div class="z6m_28">
                                        <div class="mz7_28" style="width: <?php echo e($reviewsStats['rating_distribution'][1]['percent']); ?>%;"></div>
                                    </div>
                                </div>
                                <div class="zm7_28"><?php echo e($reviewsStats['rating_distribution'][1]['count']); ?></div>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make($useWholesaleLayout ?? false ? 'wholesale.layout' : 'layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OS\home\sfera\resources\views/product/show.blade.php ENDPATH**/ ?>