                ...
                <div class="top10-slider-wrapper">
                    <div class="top10-slider-track">
                        ...
                        <div class="top10-product-card">
                            <button class="product-favorite top10-favorite-btn<?php echo e(isset($favorites['items'][$product->product_id]) ? ' favorite-filled' : ''); ?>" data-product-id="<?php echo e($product->product_id); ?>" title="<?php echo e(isset($favorites['items'][$product->product_id]) ? 'Удалить из избранного' : 'Добавить в избранное'); ?>">
                            ...
                            <a href="/product/<?php echo e($product->product_id); ?>/" class="top10-product-link">
                                <div class="top10-product-image-container">
                                    <span class="top10-rank-badge"><?php echo e($index + 1); ?></span>
                                    <img src="<?php echo e($product->image_url); ?>" alt="<?php echo e($product->product_name); ?>" onerror="this.onerror=null; this.src='/assets/img/product_empty.jpg';">
                                </div>
                                <div class="top10-product-info">
                                    <h3 class="top10-product-title"><?php echo e($product->product_name); ?></h3>
                                    ...
                                    <div class="vi_24 vi0_24 p6b3_0_4-a p6b3_0_4-a0 p6b3_0_4-a1 tsBodyMBold"
                                        ...
                                        <?php if($product->rating > 0 || $product->reviews_count > 0): ?>
                                            ...
                                            <span class="p6b3_0_4-a4">
                                                ...
                                                <span style="color: var(--textSecondary);"><?php echo e(number_format($product->reviews_count, 0, ',', ' ')); ?>&nbsp;отзыв</span>
                                            </span>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <div class="top10-product-price">
                                        <span class="top10-price-current"><?php echo e($product->product_price); ?> ₽</span>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </a>
                            <div class="product-actions" style="padding: 8px;">
                                <?php if(isset($cart['items'][$product->product_id]) && isset($cart['items'][$product->product_id]['product_amount'])): ?>
                                <button class="btn-add-to-cart" data-product-id="<?php echo e($product->product_id); ?>" type="button" style="display: none;">
                                ...
                                <a href="#" class="btn-buy-all" data-product-id="<?php echo e($product->product_id); ?>" data-max-quantity="<?php echo e($product->quantity); ?>">Купить всё</a>
                                <div class="product-quantity-control" data-product-id="<?php echo e($product->product_id); ?>">
                                    <button class="qty-btn qty-minus" data-product-id="<?php echo e($product->product_id); ?>" type="button">−</button>
                                    <input type="number" class="qty-input" value="<?php echo e($cart['items'][$product->product_id]['product_amount']); ?>" min="1" max="<?php echo e($product->quantity); ?>" data-product-id="<?php echo e($product->product_id); ?>">
                                    <button class="qty-btn qty-plus" data-product-id="<?php echo e($product->product_id); ?>" type="button">+</button>
                                </div>
                                <?php else: ?>
                                <button class="btn-add-to-cart" data-product-id="<?php echo e($product->product_id); ?>" type="button">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M3 3h2l1 4m0 0l3 11h10l3-11H6z"/>
                                        <circle cx="9" cy="20" r="1" fill="currentColor"/>
                                        <circle cx="17" cy="20" r="1" fill="currentColor"/>
                                ...
                                <a href="#" class="btn-buy-all" data-product-id="<?php echo e($product->product_id); ?>" data-max-quantity="<?php echo e($product->quantity); ?>">Купить всё</a>
                                <div class="product-quantity-control hidden" data-product-id="<?php echo e($product->product_id); ?>">
                                    <button class="qty-btn qty-minus" data-product-id="<?php echo e($product->product_id); ?>" type="button">−</button>
                                    <input type="number" class="qty-input" value="1" min="1" max="<?php echo e($product->quantity); ?>" data-product-id="<?php echo e($product->product_id); ?>">
                                    <button class="qty-btn qty-plus" data-product-id="<?php echo e($product->product_id); ?>" type="button">+</button>
                                </div>
                                <?php endif; ?>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\OS\home\sfera\resources\views/components/showcase/top10-slider.blade.php ENDPATH**/ ?>