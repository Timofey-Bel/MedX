<?php $__env->startSection('title', 'Корзина - Творческий Центр СФЕРА'); ?>
                ...
                <div class="summary-card">
                    ...
                    <button class="btn btn-primary btn-checkout" 
                        style="
                            ...
                            margin-bottom: 16px;
                        "
                        data-bind="click: function() { window.location.href = '<?php echo e(route('checkout')); ?>'; }, enable: total_cart_sum() > 0">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\OS\home\sfera\resources\views/cart.blade.php ENDPATH**/ ?>