...
@section('title', 'Вход или регистрация')

@push('styles')
<link rel="stylesheet" href="{{ asset('assets/sfera/css/login.css') }}">
@endpush
...
@enderror
                    ...
                    <div class="forgot-password" style="text-align: center; margin: 16px 0;">
...
@push('scripts')
<script src="{{ asset('assets/sfera/js/auth-login.js') }}"></script>
@endpush
