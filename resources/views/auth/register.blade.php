...
@push('styles')
<link rel="stylesheet" href="{{ asset('assets/sfera/css/register.css') }}">
@endpush
...
@enderror
                    ...
                    {{-- Чекбокс регистрации организации --}}
...
@enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea 
                                ...
                                rows="2"
                                placeholder="Будет заполнено автоматически"
                            >{{ old('org_legal_address') }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input 
                                ...
                                value="{{ old('org_director_position') }}"
                                placeholder="Будет заполнено автоматически"
                            >
                        </div>
                    ...
                    <p class="form-footer">
                        Уже есть аккаунт? <a href="{{ route('login') }}" class="link">Войти</a>
                    </p>
                </form>
            </div>
...
@push('scripts')
<script src="{{ asset('assets/sfera/js/auth-register.js') }}"></script>
<script src="{{ asset('assets/sfera/js/dadata-inn-check.js') }}"></script>
<script src="{{ asset('assets/sfera/js/auth-register-new.js') }}"></script>
@endpush
