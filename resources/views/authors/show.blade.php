{{-- 
    ...
    Миграция из legacy: site/modules/sfera/author/author.tpl
    Дата создания: 2026-02-27
--}}
@extends('layouts.app')

@section('title', 'Книги автора: ' . $author['name'] . ' - Творческий Центр СФЕРА')
            ...
            <div class="catalog-content">
                ...
                <div class="catalog-toolbar">
                    <div class="toolbar-left">
                        <h1>Книги автора: {{ $author['name'] }}</h1>
...
@if($pages > 1)
    ...
    @if($page > 1)
                    <a href="/author/?author_name={{ urlencode($author['name']) }}&page={{ $page - 1 }}" class="pagination-btn">
    ...
    @for($pageNum = $startPage; $pageNum <= $endPage; $pageNum++)
        ...
        @else
                    <a href="/author/?author_name={{ urlencode($author['name']) }}&page={{ $pageNum }}" class="pagination-btn">{{ $pageNum }}</a>
        @endif
    @endfor
    @if($page < $pages)
                    <a href="/author/?author_name={{ urlencode($author['name']) }}&page={{ $page + 1 }}" class="pagination-btn">
