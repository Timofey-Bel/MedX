...
var FavoritesModel = {
    constructor: function(){
        ...
        @include('js.models.favorites.add_to_favorites')
        @include('js.models.favorites.remove_from_favorites')
        @include('js.models.favorites.clear_favorites')
        @include('js.models.favorites.update_items')
        @include('js.models.favorites.update_favorites')
        @include('js.models.favorites.refresh_favorites')
