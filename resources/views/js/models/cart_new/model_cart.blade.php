...
var CartModel = {
    constructor: function(){
        ...
        @include('js.models.cart_new.put_into_cart')
        @include('js.models.cart_new.remove_from_cart')
        @include('js.models.cart_new.clear_cart')
        @include('js.models.cart_new.update_amount')
        @include('js.models.cart_new.amount_plus')
        @include('js.models.cart_new.amount_minus')
        @include('js.models.cart_new.validate_amount')
        @include('js.models.cart_new.update_items')
        @include('js.models.cart_new.update_cart')
        @include('js.models.cart_new.try2apply_promocode')
        @include('js.models.cart_new.try2cancel_promocode')
        @include('js.models.cart_new.update_delivery_price')
        @include('js.models.cart_new.refresh_cart')
        @include('js.models.cart_new.update_item_selected')
