{{-- 
    Страница тематики с её товарами
    Миграция из legacy: site/modules/sfera/topic/topic.tpl
    Дата создания: 2026-02-27
--}}
@extends('layouts.app')

@section('title', 'Товары тематики: ' . $topic['name'] . ' - Творческий Центр СФЕРА')
            ...
            <div class="catalog-content">
                ...
                <div class="catalog-toolbar">
                    <div class="toolbar-left">
                        <h1>Товары тематики: {{ $topic['name'] }}</h1>
...
@if($pages > 1)
    ...
    @if($page > 1)
                    <a href="/topic/?topic_id={{ $topic['id'] }}&page={{ $page - 1 }}" class="pagination-btn">
    ...
    @for($pageNum = $startPage; $pageNum <= $endPage; $pageNum++)
        ...
        @else
                    <a href="/topic/?topic_id={{ $topic['id'] }}&page={{ $pageNum }}" class="pagination-btn">{{ $pageNum }}</a>
        @endif
    @endfor
    @if($page < $pages)
                    <a href="/topic/?topic_id={{ $topic['id'] }}&page={{ $page + 1 }}" class="pagination-btn">
