...
<footer class="dj5_11" data-widget="footer" style="margin-top:0px;">
    ...
    <div class="jd5_11" >
        <div class="dj6_11" >
            <a target="_self" href="{{ route('home') }}" class="q4b012-a j6d_11" ><img loading="lazy" fetchpriority="low" src="{{ asset('assets/sfera/img/logo/logo_dark.svg') }}" alt="ClustBUY" crossorigin="anonymous" class="dj7_11 b9100-a" ></a>
            <div class="d6j_11" >


                <a target="_self" href="{{ route('page', ['slug' => 'Работа у нас']) }}" class="q4b012-a jd6_11" ><span class="jd8_11" style="color:;">
                ...
                <a target="_self" href="{{ route('page', ['slug' => 'Мероприятия']) }}" class="q4b012-a jd6_11" ><span class="jd8_11" style="color:;">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="j5d_11" >
                ...
                <a target="_self" href="{{ route('page', ['slug' => 'Контакты']) }}" class="q4b012-a jd6_11" ><span class="jd8_11" style="color:;">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="j5d_11" >
            ...
            <div class="jd7_11" >
                <div class="dk_11" >
                    <div class="kd_11" >
                        ...
                        <a title="Об издательстве" target="_self" href="{{ route('page', ['slug' => 'О нас']) }}" class="q4b012-a d0k_11" >Об издательстве</a>

                    </div>

                    <div class="kd_11" >
                        <span class="dk0_11" >Покупателям</span>
                        <a target="_self" href="{{ route('page', ['slug' => 'Электронный каталог и презентации']) }}" class="q4b012-a d0k_11" >Каталоги продукции</a>
                        <a target="_self" href="{{ route('page', ['slug' => 'Обзоры продукции']) }}" class="q4b012-a d0k_11" >Обучающие видео</a>
                        <a target="_self" href="{{ route('page', ['slug' => 'Опт']) }}" class="q4b012-a d0k_11" >Оптовым клиентам</a>
                        <a target="_self" href="{{ route('page', ['slug' => 'Розница']) }}" class="q4b012-a d0k_11" >Розничным покупателям</a>
                        <a target="_self" href="{{ route('page', ['slug' => 'Контакты']) }}" class="q4b012-a d0k_11" >Контакты</a>

                    </div>

                    <div class="kd_11" >
                        <span class="dk0_11" >Помощь</span>
                        <a target="_self" href="{{ route('page', ['slug' => 'Где купить']) }}" class="q4b012-a d0k_11" >Как купить</a>
                        <a target="_self" href="{{ route('page', ['slug' => 'Покупателям']) }}" class="q4b012-a d0k_11" >Как оформить заказ</a>
                        <a target="_self" href="{{ route('page', ['slug' => 'Покупателям']) }}" class="q4b012-a d0k_11" >Возврат</a>
                        <a target="_self" href="{{ route('page', ['slug' => 'Бесплатная доставка']) }}" class="q4b012-a d0k_11" >Способы доставки</a>
                        <a target="_self" href="{{ route('page', ['slug' => 'Покупателям']) }}" class="q4b012-a d0k_11" >Способы оплаты</a>
                        <a target="_self" href="{{ route('page', ['slug' => 'Предложить книгу']) }}" class="q4b012-a d0k_11" >Обратная связь</a>
                ...
                <div class="j7d_11" >
                    ...
                    <div >
                        ...
                        <a target="_self" href="{{ route('home') }}" class="q4b012-a w1c_11 dj8_11" >
                            <div class="bq022-a" style="color:rgba(0, 26, 52, 0.6);">
                                <span class="tsBody400Large" >© {{ date('Y') }} Творческий Центр СФЕРА</span>
                            </div>
                        </a>
