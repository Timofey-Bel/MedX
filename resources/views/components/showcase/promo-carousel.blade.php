{{-- 
    Промо-карусель (нижняя правая часть)
    Миграция из legacy: legacy/site/modules/sfera/promo_carousel/promo_carousel.tpl
    
    Props:
    - $products (array): Массив товаров/промо с полями image, name
    - $carouselId (string): Уникальный ID карусели для JavaScript (по умолчанию 'promo')
--}}
@props(['products' => [], 'carouselId' => 'promo'])
