{{-- 
    TOP-10 товаров слайдер
    Миграция из legacy: legacy/site/modules/sfera/top10_products/top10_products.tpl
--}}
                ...
                <div class="top10-slider-wrapper">
                    <div class="top10-slider-track">
                        ...
                        <div class="top10-product-card">
                            <button class="product-favorite top10-favorite-btn{{ isset($favorites['items'][$product->product_id]) ? ' favorite-filled' : '' }}" data-product-id="{{ $product->product_id }}" title="{{ isset($favorites['items'][$product->product_id]) ? 'Удалить из избранного' : 'Добавить в избранное' }}">
                            ...
                            <a href="/product/{{ $product->product_id }}/" class="top10-product-link">
                                <div class="top10-product-image-container">
                                    <span class="top10-rank-badge">{{ $index + 1 }}</span>
                                    ...
                                    <div class="vi_24 vi0_24 p6b3_0_4-a p6b3_0_4-a0 p6b3_0_4-a1 tsBodyMBold"
                                        ...
                                        @if($product->rating > 0 || $product->reviews_count > 0)
                                            ...
                                            <span class="p6b3_0_4-a4">
                                                ...
                                                <span style="color: var(--textSecondary);">{{ number_format($product->reviews_count, 0, ',', ' ') }}&nbsp;отзыв</span>
                                            </span>
                                            @endif
                                        @endif
                                    </div>
