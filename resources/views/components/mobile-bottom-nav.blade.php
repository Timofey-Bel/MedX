...
<nav class="mobile-bottom-nav">
    ...
    <a href="{{ route('catalog.index') }}" class="mobile-bottom-nav-item {{ request()->routeIs('catalog*') ? 'active' : '' }}">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
{{ route('login') }}
@endauth
" class="mobile-bottom-nav-item {{ request()->routeIs('my.*') || request()->routeIs('lk.*') || request()->routeIs('login') ? 'active' : '' }}">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
