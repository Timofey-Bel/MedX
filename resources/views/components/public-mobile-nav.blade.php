...
<nav class="public-mobile-nav">
    <a href="{{ url('/') }}" class="public-mobile-nav-item {{ request()->is('/') ? 'active' : '' }}">
    ...
    <a href="{{ url('/about') }}" class="public-mobile-nav-item {{ request()->is('about') ? 'active' : '' }}">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="{{ url('/faq') }}" class="public-mobile-nav-item {{ request()->is('faq') ? 'active' : '' }}">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    @guest
        <a href="{{ url('/login') }}" class="public-mobile-nav-item {{ request()->is('login') ? 'active' : '' }}">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    @else
        <a href="{{ url('/main_showcase') }}" class="public-mobile-nav-item">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
